    ...
    OrderBookData: pa.schema(
        {
            ...
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
            "action": pa.dictionary(pa.uint8(), pa.string()),
            "side": pa.dictionary(pa.uint8(), pa.string()),
            "price": pa.float64(),
            "size": pa.float64(),
            "order_id": pa.string(),
            "book_type": pa.dictionary(pa.uint8(), pa.string()),
    ...
    ComponentStateChanged: pa.schema(
        {
            ...
            "state": pa.dictionary(pa.int16(), pa.string()),
            "config": pa.string(),
            "event_id": pa.string(),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
    ...
    PositionOpened: pa.schema(
        {
            ...
            "entry": pa.dictionary(pa.int8(), pa.string()),
